...
(/** @lends <global> */function($, window, document, undefined) {
    ...
    var DataTable = function( oInit )
    {
        ...
        function _fnFeatureHtmlLength ( oSettings )
        {
            ...
            nLength.innerHTML = '<label style="margin-left: 30px">'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label>';
    ...
    DataTable.defaults = {
        ...
        "oLanguage": {
             ...
             *    } );
             */
            "sInfo": "<label style='margin-left: 30px'>Showing _START_ to _END_ of _TOTAL_ entries</label>",
