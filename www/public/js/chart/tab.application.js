        ...
        var database = new MMTDrop.Database( {action: "aggregate"},
          ...
          function( data ){
            ...
            for( var i=0; i<data.length; i++ ){
              ...
              data[i][ HTTP.DATA_TRANSFER_TIME.id ] = _this.divide( data[i][ HTTP.DATA_TRANSFER_TIME.id ], val);
        ...
        function createBar( is_trans ){
          ...
          return MMTDrop.chartFactory.createBar({
            ...
            chart: {
              ...
              color: {
                pattern: (is_trans ? ["green"] : ['violet', 'orange', 'DeepSkyBlue'])
              },
              bar : {
                width: 15,
              },
            ...
            getData: {
                getDataFn: function (db) {
                    ...
                    for( var i=0; i<arr.length; i++ ){
                        ...
                        obj[ HTTP.DATA_TRANSFER_TIME.id ] = self.divide( obj[ HTTP.DATA_TRANSFER_TIME.id ], obj[ HTTP.TRANSACTIONS_COUNT.id ] * 1000 );
