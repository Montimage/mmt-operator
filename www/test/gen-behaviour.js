...
function getCategory() {
    return CategoriesIdsMap[rand(15)];
}
...
function writeToFile() {
    ...
    for (var i = 0; i < 10; i++) {
        var ip = ips[ rand( ips.length ) ];

        var msg = '12,123,"eth0",' + ts + ',2,"' + ip + '","' + getCategory() + '","' + getCategory() + '","Compare_bandwidth_use_of_last_hour_with_average_of_the_same_hour_in_the_last_3_weeks"';

        fs.appendFileSync(file_name, msg + "\n");
        
                var msg = '11,123,"eth0",' + ts + ',2,"' + ip + '","' + getApp() + '","' + getApp() + '","Bandwidth Test"';
